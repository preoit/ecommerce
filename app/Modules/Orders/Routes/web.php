...
Route::get('/admin/orders/{order}/edit', [ManualOrderController::class, 'edit'])->name('orders.edit');
Route::post('/admin/orders/customers', [QuickCustomerController::class, 'store'])->name('orders.customers.store');
Route::patch('/admin/orders/customers/{customer}', [QuickCustomerController::class, 'update'])->name('orders.customers.update');
Route::post('/admin/orders', [ManualOrderController::class, 'store'])->name('orders.store');
Route::patch('/admin/orders/{order}', [ManualOrderController::class, 'update'])->name('orders.update');
Route::delete('/admin/orders/{order}', [ManualOrderController::class, 'destroy'])->name('orders.destroy');
