        ...
        <div className={cn('min-h-screen transition-colors', darkMode ? 'dark bg-slate-950 text-slate-100' : 'bg-[#f8f7fa] text-slate-900')}>
            ...
            <div className="lg:pl-64">
                ...
                <main className="mx-auto w-full max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
                    {flash?.success && (
                        <div className="mb-2 ml-auto flex w-full max-w-xl items-center gap-3 rounded-xl border border-emerald-200 border-l-4 border-l-emerald-500 bg-emerald-50/70 px-4 py-3 shadow-[0_8px_20px_rgba(5,150,105,.08)] dark:border-emerald-900 dark:border-l-emerald-500 dark:bg-emerald-950/30" role="status">
