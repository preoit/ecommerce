...
export default function CartDrawer({ open, onClose }) {
    ...
    return <div className={`fixed inset-0 z-[100] ${open ? 'pointer-events-auto' : 'pointer-events-none'}`} aria-hidden={!open}>
        ...
        <aside role="dialog" aria-modal="true" aria-labelledby="cart-drawer-title" className={`absolute inset-y-0 right-0 flex w-full max-w-[530px] flex-col bg-white shadow-[-18px_0_55px_rgba(15,23,42,.20)] transition-transform duration-300 ease-out ${open ? 'translate-x-0' : 'translate-x-full'}`}>
