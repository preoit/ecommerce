    ...
    return <><Head title={`${order.number} Shipping Label`} />
        ...
        <div className="label-workspace min-h-screen bg-slate-100 px-4 pb-10">
            <div className="label-toolbar sticky top-0 z-20 mx-auto mb-6 flex max-w-4xl items-center justify-between gap-4 border-b border-slate-200 bg-slate-100/95 py-4 backdrop-blur">
                ...
                <button type="button" onClick={() => window.print()} className="inline-flex h-11 items-center gap-2 rounded-xl bg-violet-600 px-5 text-sm font-bold text-white shadow-sm transition-colors duration-200 hover:bg-violet-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-violet-200"><Printer className="size-4" />Print A5 Label</button>
            </div>
