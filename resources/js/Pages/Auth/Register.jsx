...
export default function Register() {
    ...
    return <AuthLayout><Head title="Create account" />
        <h1 className="text-2xl font-medium text-[#36354a]">Adventure starts here 🚀</h1><p className="mt-1 text-sm text-slate-500">Create your customer account to order and track purchases.</p>
