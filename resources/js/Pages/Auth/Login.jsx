...
export default function Login({ status, canResetPassword }) {
    ...
    return <AuthLayout><Head title="Log in" />
        <h1 className="text-2xl font-medium text-[#36354a]">Welcome back! 👋</h1><p className="mt-1 text-sm text-slate-500">Please sign-in to your account and start the adventure</p>
        ...
        <p className="mt-6 text-center text-sm text-slate-600">New on our platform? <Link href={route('register')} className="font-medium text-[#6c5ce7]">Create an account</Link></p>
